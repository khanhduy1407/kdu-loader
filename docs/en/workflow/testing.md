...
> The [webpack kdu-cli template](https://github.com/khanhduy1407/kdu-cli-webpack) offers pre-configured unit testing and e2e testing setups for you.

When testing `*.kdu` files, we cannot use a plain CommonJS-based test runner because it won't know how to handle `*.kdu` files. Instead, we still use Webpack + kdu-loader to bundle our test files. The recommended setup is using [Karma](https://karma-runner.github.io/0.13/index.html) and [karma-webpack](https://github.com/webpack/karma-webpack).
...
var Kdu = require('kdu')
var ComponentA = require('../../src/components/a.kdu')

describe('a.kdu', function () {
...
Again, [webpack kdu-cli template](https://github.com/khanhduy1407/kdu-cli-webpack) contains a fully working example with tests.
